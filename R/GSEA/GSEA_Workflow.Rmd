...
## Butterfly plot / back-to-back stacked bar chart
...
- [ ] Re-run `combinedGSEA` using `mroast` instead of `fry` to get the proportions of genes that are up- and down-regulated. 
